defmodule Nebulith.Repo.Migrations.APathIsLighterThanTheGround do
  @moduledoc """
  The jungle's trail goes from #57502f to #8a7550, so a path reads as a path.

  Measured on the five isometric references he gave for pathways, the path is LIGHTER than the field every
  single time, by 35 to 128 points of luminance:
