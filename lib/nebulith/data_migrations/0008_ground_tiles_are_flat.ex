defmodule Nebulith.DataMigration.GroundTilesAreFlat do
  ...
  `0007_all_blocks_min_height_1` raised EVERY tile below 1.0 up to 1.0 ("all tiles/blocks are height 1 by
  ...
  Registered AFTER 0007 in `mix data_migrate`, which raises everything to 1 and would otherwise undo this.
