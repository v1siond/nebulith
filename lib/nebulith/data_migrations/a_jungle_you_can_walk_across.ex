defmodule Nebulith.DataMigration.AJungleYouCanWalkAcross do
  @moduledoc """
  The jungle opens up: canopy 0.369 to 0.31 and groundCover 0.3 to 0.2, dense 0.428 to 0.36.

  The density of trees was conflicting with the functionality of the map: no room to move, nowhere to put
  treasures or units.
  ...
  def run do
    ...
    Logger.info("[data_migrate] jungle and dense woodland densities relaxed")
    :ok
  end
end
