defmodule Nebulith.Catalog.AbilitySource do
  ...
  @abilities [
    %{slug: "fire-slash", name: "Fire Slash", category: "offensive",
      animation: "fire-slash", cooldown_ms: 6000, position: 1,
      description: "A blazing melee slash \u2014 the blade burns red-orange and bites for fire damage.",
      effect: %{"damage" => 18}},
    %{slug: "power-shot", name: "Power Shot", category: "offensive",
      animation: "piercing-shot", cooldown_ms: 8000, position: 2,
      description: "A drawn-back piercing bolt \u2014 slower to ready, but it punches through for big damage.",
      effect: %{"damage" => 26}},
    %{slug: "guard", name: "Guard", category: "defensive",
      animation: "guard-flash", cooldown_ms: 12000, position: 3,
      description: "Raise a flash-guard for a few seconds, cutting the damage you take.",
      effect: %{"shieldMs" => 4000}},
    %{slug: "frost", name: "Frost", category: "debuff",
      animation: "ice-slash", cooldown_ms: 9000, position: 4,
    ...
    %{slug: "cleave", name: "Cleave", category: "offensive",
      animation: "cleave", cooldown_ms: 7000, position: 5,
      description: "A wide, two-handed swing that cleaves through for heavy physical damage.",
      effect: %{"damage" => 22}},
    %{slug: "arcane-bolt", name: "Arcane Bolt", category: "offensive",
      animation: "bolt", cooldown_ms: 5000, position: 6,
      description: "A quick bolt of raw arcane force \u2014 short cooldown, reliable ranged damage.",
      effect: %{"damage" => 20}},
    %{slug: "nova-burst", name: "Nova Burst", category: "offensive",
      animation: "nova", cooldown_ms: 14000, position: 7,
      description: "A violet nova that detonates around you \u2014 slow to charge, hits hard.",
      effect: %{"damage" => 30}},
    %{slug: "chain-lightning", name: "Chain Lightning", category: "offensive",
      animation: "lightning", cooldown_ms: 11000, position: 8,
      description: "A forked bolt of lightning that arcs into the target for strong shock damage.",
      effect: %{"damage" => 24}},
    %{slug: "bulwark", name: "Bulwark", category: "protection",
      animation: "guard-flash", cooldown_ms: 16000, position: 9,
      description: "Brace behind a heavy bulwark \u2014 a long window that soaks most incoming damage.",
      effect: %{"shieldMs" => 6000}},
    %{slug: "poison-dart", name: "Poison Dart", category: "debuff",
      animation: "piercing-shot", cooldown_ms: 8000, position: 10,
    ...
    %{slug: "enfeeble", name: "Enfeeble", category: "debuff",
      animation: "nova", cooldown_ms: 10000, position: 11,
    ...
    %{slug: "mend", name: "Mend", category: "healing",
      animation: "heal-glow", cooldown_ms: 10000, position: 12,
      description: "A burst of restorative light \u2014 mends a solid chunk of your health.",
      effect: %{"healing" => 25}},
    %{slug: "renew", name: "Renew", category: "healing",
      animation: "heal-glow", cooldown_ms: 7000, position: 13,
