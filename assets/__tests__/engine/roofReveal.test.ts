 ...
 * would punch a HOLE in the roof instead of removing it. `revealedRoofs` therefore takes the CONNECTED roof, * every roof block whose footprint touches the one the hero is under, so the whole roof comes off as one.
 */
