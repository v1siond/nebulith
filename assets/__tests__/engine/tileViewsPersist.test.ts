import { installStyleTiles, setTilePose, styleTiles } from '@/engine/tileset/styleTiles'
...
test('a tile views map survives setTilePose + the JSON blob the save PUTs', () => {
  ...
  setTilePose('emoji', 'tree', { rot: 0.3 }) // the editor's live pose write — per STYLE, then label
