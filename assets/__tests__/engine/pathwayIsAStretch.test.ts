 ...
 *
 * Alexander, 2026-09-13, stopping the review to settle the vocabulary first:
 *
 *   *"what does 4 pathways even mean for you? because for example, if we cross two paths like a cross, we
 *   could have 4 exits in two pathways, but if we're counting from the center out, then we'd count 4
 *   pathways instead of 2 correctly / so a pathway is a stretch of road that has 1 or 2 exit / either on
 *   oposites sides of it, if 2, or at the start of it if it's 1"*
 *
