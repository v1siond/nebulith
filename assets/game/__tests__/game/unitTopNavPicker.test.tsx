...
import { UnitPicker, UnitPlacementBody } from '@/components/editorChrome'
...
// The three placement decisions moved OUT of the picker into their own movable panel, // 2026-09-09: Stacked under the grid they crushed the swatches into one clipped row. They were relabelled
...
describe('◈ How a character lands, the behaviour panel', () => {
  ...
  it('whose side is two answers, not three, neither pressed means the creature decides', () => {
    // So `auto` survives as the DEFAULT, never as a third button.
