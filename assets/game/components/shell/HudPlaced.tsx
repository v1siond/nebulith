 ...
 *
 * They could not be moved because their position was `fixed bottom-16 left-1/2` written into the markup — there was
 * nothing to move. Wrapping a piece in this makes its position DATA: the profile's placement for that element, in the
 * form factor being played.
 *
 ...
 *
 * No placement, no render — and it says why. The seeded default carries one for every element in the inventory, so a
 * missing placement means the profile did not load, and drawing the piece at a position this file invented is exactly
 * the hardcoded fallback the migration exists to remove.
 */
