...
/** VIEW → WORLD, the inverse of `orientCellTurn` (what a pick needs). At a WHOLE turn it IS `deorientCell`, *  integer in, integer out. Mid-turn it returns a FRACTIONAL world coord: the caller floors it to a cell. */
