 ...
 *
 * So there is no maximum here. There were two of them before, and both were wrong for the same reason, * each turned a performance characteristic into a rule about what the user is allowed to want:
 *
