 ...
 *
 * Alexander, 2026-09-11: *"please make sure the player is always in a zone we can walk when generating a new
 * map, it happens multiple times to me that we create a map, and I'm stuck and cant go anywhere"*.
 *
