 ...
 *
 * Alexander, 2026-09-11: *"on units we need to have a dialog system, each unit has many dialogs, some dialogs are
 * linked to quests, others are static and others are event of situational based"*.
 *
