 ...
 *  WHY it is not the diamond centre: the page has always projected the cell's `(col+0.5, row+0.5)` corner, *  the halves cancel in x and add exactly one tile-height in y, landing on the ground diamond's FRONT vertex.
