...
/**
 * In render order. A UNIT relabels two of these, §4.7 draws "WHO IS IT" where a cell says "WHAT IS IT", * so the title is resolved through `sectionTitle`, not baked in here.
 *
